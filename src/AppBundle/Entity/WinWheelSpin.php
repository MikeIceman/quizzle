...
class WinWheelSpin
{
     ...
     *     type="datetime",
     *     nullable=false,
     *     options={"comment":"Date and time when spinned"}
     * )
     */
    private $dateSpinned;
     ...
     *     type="string",
     *     nullable=false,
     *     columnDefinition="enum('cash', 'bonus', 'prize', 'nothing')",
     *     options={"default": "nothing", "comment":"Winned prize type"}
     * )
     */
    private $prizeType;
     ...
     *     scale=2,
     *     nullable=true,
     *     options={"default" : 0, "comment":"Bonus or cash amount, prize cost if item winned"}
     * )
     */
    private $prizeAmount;
     ...
     *     options={"default": "pending", "comment":"Spin status"}
     * )
     */
    private $status;
